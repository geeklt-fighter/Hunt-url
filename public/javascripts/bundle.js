...
function () {
  ...
  regeneratorRuntime.mark(function _callee(url) {
    var res, accountuserimg, headeruserimg;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              accountuserimg = document.querySelector('.form__user-photo');
              headeruserimg = document.querySelector('.nav__user-img');
...
if (headeruserimg) {
  headeruserimg.onload = function () {
    console.log("Image loaded, size ".concat(headeruserimg));
  };

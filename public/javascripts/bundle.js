...
var recommend = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(user, url, title, descr, postId) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:3001/api/v1/posts/".concat(postId),
              headers: {
          ...
          case 8:
            res2 = _context.sent;
            console.log('Response 2: ', res2); // document.getElementById('result').innerHTML = res.data.answer.join("\n")
